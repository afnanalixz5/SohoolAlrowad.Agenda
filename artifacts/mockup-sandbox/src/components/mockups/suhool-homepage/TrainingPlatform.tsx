...
export function TrainingPlatform() {
  ...
  return (
    <main dir="rtl" className="min-h-[100dvh] overflow-x-hidden bg-[#f4efe5] text-[#182945]" style={{ fontFamily: "var(--font-sans, 'Tahoma', sans-serif)", ["--font-display" as string]: "'Tahoma', 'Arial Unicode MS', sans-serif" }}>
      <style>{`
