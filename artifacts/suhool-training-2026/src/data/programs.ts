...
const content: Record<string, Content> = {
  ...
  entrepreneurship: {
    overview: "برنامج CBP يعرّف الشباب بمراحل تأسيس المشروع، فهم العميل، بناء النموذج، وإدارة خطوات الانطلاق.",
...
const seeds: Seed[] = [
  ...
  { id: "p14", date: "18/10/2026", month: "أكتوبر", monthOrder: 10, day: "18", name: "شهادة كومبتيا أساسيات الشبكات Network+ + CompTIA Network+", mode: "حضوري", city: "المجر - بودابست", days: 5, kind: "network", imageSlug: "network-plus", logoKeys: ["comptia", "network"], logoLabels: ["CompTIA", "Network+"] },
  ...
  { id: "p28", date: "22/11/2026", month: "نوفمبر", monthOrder: 11, day: "22", name: "محترف ريادة الأعمال للشباب CBP", mode: "حضوري / عن بعد", city: "الرياض", days: 5, kind: "entrepreneurship", imageSlug: "cbp-entrepreneurship", logoKeys: ["ibta", "cbp"], logoLabels: ["IBTA", "CBP"], isHadafFunded: true },
